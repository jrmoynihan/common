...
<label for={id} {...label_attributes} class={['_checkbox-label', label_attributes?.class]}>
		...
		label._checkbox-label {
			...
			--checkbox-default-transition-function: var(
				...
				var(
					...
					var(--checkbox-default-transition-timing-function)
				);
			...
			--checbox-default-label-transition: background-color
				var(--checkbox-default-transition-function);
			...
			border-radius: var(
				...
				var(--checkbox-default-label-border-radius)
			);
