<script lang="ts">
	...
	$: {
		date;
		is_valid = dateInput?.checkValidity();
		invalid_msg = dateInput?.validationMessage;
	}
	$: console.log('internal', internal_string_date);
	$: console.log('date', date);
</script>

<label for={name} style={label_styles} transition:transition={transition_params}>
...
<style lang="scss">
	...
	.invalid-msg {
		...
		background: var(--date-input-invalid-message-background, inherit);
