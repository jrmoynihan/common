...
{#snippet default_fly_transition({x = '-50%', y = '0px', outX = '50%', outY = '0px', duration, delay, easing, opacity = 0})}
...
{#snippet default_blur_transition({duration, delay, easing, opacity = 0, amount = '5px'})}
		{@render transition({ duration, delay, easing, initial_opacity: opacity, amount, types: ['blur']})}
{/snippet}
...
{#snippet default_scale_transition({duration, delay, easing, initial_scale = 0, out_scale, opacity})}
		{@render transition({ duration, delay, easing, initial_scale, out_scale, initial_opacity: opacity, types: ['scale']})}
{/snippet}
