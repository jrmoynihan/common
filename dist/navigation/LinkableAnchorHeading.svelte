...
let copied = false;
let timeout;
export let styles = 'border: 0; --button-opacity: 0.5; padding: 0rem 0.5rem; max-height: max-content; margin: 0.25rem 0.5rem;';
export let copied_styles = 'background: hsla(var(--link-background-value), 75%);';
export let button_placement = 'after';
export let heading_props;
