...
export let expand_icon_position = 'right';
export let custom_expand_icon = null;
export let icon_class = 'fa-CaretDown';
export let custom_summary_styles = '';
export let custom_accordion_container_styles = '';
export let open = false;
export let transition = slide;
export let transition_parameters = { duration: 300, easing: cubicInOut };
export let closed_icon_rotation = 90; // in degrees
export let open_icon_rotation = -90; // in degrees
export let summary_tooltip_parameters = { disabled: true };
