<script>// Inspired by https://dev.to/evanwinter/page-transitions-with-svelte-kit-35o6
...
export let in_transition = fly;
export let in_transition_parameters = {
    duration: 200,
    delay: 300,
    easing: cubicOut
};
export let out_transition = fly;
export let out_transition_parameters = {
