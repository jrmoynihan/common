...
export let box_shadow_elevation = 'low';
...
button:hover.low, button:focus-visible.low {
  box-shadow: var(--button-hover-box-shadow, var(--shadow-elevation-low));
}
button:hover.medium, button:focus-visible.medium {
  box-shadow: var(--button-hover-box-shadow, var(--shadow-elevation-medium));
}
button:hover.high, button:focus-visible.high {
