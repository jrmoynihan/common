...
<script>import { dynamicStyle } from '../dynamic-styles.js';
...
export let position_type = 'fixed';
export let x = 0;
export let y = 0;
...
export let custom_component = null;
...
<style>.tooltip {
  ...
  max-width: min(var(--tooltip-max-width, min(100vw - 2rem), 250px), min(100vw - 2rem, 250px));
...
.arrow::after {
  ...
  border-color: var(--tooltip-arrow-color, var(--tooltip-background, var(--tooltip-background-color, white)));
  border-width: var(--default-arrow-size, 0.5rem);
}
.arrow[data-tip-position=left], .arrow[data-tip-position=right] {
  width: calc(var(--tooltip-arrow-width, var(--default-arrow-size, 0.5rem)) + var(--arrow-cushion, 4px));
...
.arrow[data-tip-position=left]::after, .arrow[data-tip-position=right]::after {
  border-top: var(--tooltip-arrow-height, var(--default-arrow-size, 0.5rem)) solid transparent;
  border-bottom: var(--tooltip-arrow-height, var(--default-arrow-size, 0.5rem)) solid transparent;
}
.arrow[data-tip-position=bottom], .arrow[data-tip-position=top] {
  width: calc(var(--tooltip-arrow-width, calc(var(--default-arrow-size, 0.5rem) * 2)));
  height: calc(var(--tooltip-arrow-height, var(--default-arrow-size, 0.5rem)) + var(--arrow-cushion, 4px));
  left: calc(50% - var(--tooltip-arrow-width, var(--default-arrow-size, 0.5rem)));
}
.arrow[data-tip-position=bottom]::after, .arrow[data-tip-position=top]::after {
  border-left: var(--tooltip-arrow-height, var(--default-arrow-size, 0.5rem)) solid transparent;
  border-right: var(--tooltip-arrow-height, var(--default-arrow-size, 0.5rem)) solid transparent;
}
.arrow[data-tip-position=bottom] {
  top: calc(-1 * var(--tooltip-arrow-height, var(--default-arrow-size, 0.5rem)) + -1 * var(--arrow-cushion, 4px)); /* overlap with the tooltip box */
}
.arrow[data-tip-position=bottom]::after {
  border-bottom: var(--tooltip-arrow-width, var(--default-arrow-size, 0.5rem)) solid var(--tooltip-arrow-color, var(--tooltip-background, var(--tooltip-background-color, white)));
}
.arrow[data-tip-position=top] {
  top: calc(100% + -1 * var(--arrow-cushion, 0px)); /* overlap with the tooltip box */
}
.arrow[data-tip-position=top]::after {
  border-top: var(--tooltip-arrow-width, var(--default-arrow-size, 0.5rem)) solid var(--tooltip-arrow-color, var(--tooltip-background, var(--tooltip-background-color, white)));
}
.arrow[data-tip-position=left] {
  left: calc(100% + -1 * var(--arrow-cushion, 0px)); /* overlap with the tooltip box */
}
.arrow[data-tip-position=left]::after {
  border-left: var(--tooltip-arrow-width, var(--default-arrow-size, 0.5rem)) solid var(--tooltip-arrow-color, var(--tooltip-background, var(--tooltip-background-color, white)));
}
.arrow[data-tip-position=right] {
  left: calc(-1 * var(--tooltip-arrow-width, 0.75rem) + -1 * var(--arrow-cushion, 0px));
}
.arrow[data-tip-position=right]::after {
  border-right: var(--tooltip-arrow-width, var(--default-arrow-size, 0.5rem)) solid var(--tooltip-arrow-color, var(--tooltip-background, var(--tooltip-background-color, white)));
}
